...
/**
 * BuildML CLI Command class that implements the "make-atomic" command.
 * 
 * @author "Peter Smith <psmith@arapiki.com>"
 */
public class CliCommandMakeAtomic implements ICliCommand {
	...
	public String getShortDescription() {
		return "Make an action atomic (removing child actions).";
	}
