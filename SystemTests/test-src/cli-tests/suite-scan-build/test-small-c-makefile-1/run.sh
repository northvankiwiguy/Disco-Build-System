...
match "bml show-actions -l -f 1" "small-c-makefile all"
match "bml show-files-used-by -r 1" "small-c-makefile/Makefile"
match_empty "bml show-files-used-by -w 1"

# test action 2 - the make that enters subdir1
match "bml show-actions -l -f 2" "/bin/make -C subdir1 all"
match "bml show-files-used-by -r 2" "subdir1/Makefile"

# test action 3 - the compile of file1.c. Doesn't read or write files.
match "bml show-actions -l -f 3" "-c file1.c"
match_empty "bml show-files-used-by -r 3"
match_empty "bml show-files-used-by -w 3"

# test action4 - the cc1 operation on file1.c
match "bml show-actions -l -f 4" "cc1"
match "bml show-files-used-by -r 4" "subdir1/file1.c"

# test action5 - the as1 operation to produce file1.o
match "bml show-actions -l -f 5" "/bin/as"
match "bml show-files-used-by -w 5" "subdir1/file1.o"

# test action19 - writing to /dev/null should not log a file access
match "bml show-actions -l -f 19" "echo Hello"
match_empty "bml show-files-used-by 19"
