...
/**
 * An Eclipse UI Handler for managing the "Open Package" UI command.
 * 
 * @author Peter Smith <psmith@arapiki.com>
 */
public class HandlerOpenPackage extends AbstractHandler {
	...
	public boolean isEnabled() {
		...
		if (mainEditor != null) {
			OutlinePage outlinePage = (OutlinePage)mainEditor.getAdapter(IContentOutlinePage.class);
			return outlinePage.getOpenEnabled();
		}
		return false;
	}
