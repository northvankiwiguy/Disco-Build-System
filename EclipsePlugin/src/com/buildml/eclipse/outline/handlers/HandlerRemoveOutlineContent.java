...
/**
 * An Eclipse UI Handler for managing the "Remove Package/Folder" UI command.
 * 
 * @author Peter Smith <psmith@arapiki.com>
 */
public class HandlerRemoveOutlineContent extends AbstractHandler {
	...
	public boolean isEnabled() {
		...
		if (mainEditor != null) {
			OutlinePage outlinePage = (OutlinePage)mainEditor.getAdapter(IContentOutlinePage.class);
			return outlinePage.getRemoveEnabled();
		}
		return false;
	}
