...
/**
 * An Eclipse UI Handler for managing the "Rename Package/Folder" UI command.
 * 
 * @author Peter Smith <psmith@arapiki.com>
 */
public class HandlerRenameOutlineContent extends AbstractHandler {
	...
	public boolean isEnabled() {
		...
		if (mainEditor != null) {
			OutlinePage outlinePage = (OutlinePage)mainEditor.getAdapter(IContentOutlinePage.class);
			return outlinePage.getRenameEnabled();
		}
		return false;
	}
