...
/**
 * The activator class for the BuildML editor. A single instance of this class is
...
public class Activator extends AbstractUIPlugin {
	...
	/** The plug-in ID for the BuildML editor */
	public static final String PLUGIN_ID = "com.buildml";
