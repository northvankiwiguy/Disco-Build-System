...
#include "com_arapiki_utils_os_SystemUtils.h"
...
/*
 * Class:     com_arapiki_utils_os_SystemUtils
 * Method:    isSymlink
 * Signature: (Ljava/lang/String;)Z
 */
JNIEXPORT jboolean JNICALL Java_com_arapiki_utils_os_SystemUtils_isSymlink
 ...
 */
JNIEXPORT jstring JNICALL Java_com_arapiki_utils_os_SystemUtils_readSymlink
  (JNIEnv *env, jobject jobj, jstring fileName)
{
	/* NULL pointers not allowed */
	if (fileName == NULL){
 ...
 */
JNIEXPORT jint JNICALL Java_com_arapiki_utils_os_SystemUtils_createSymlink
